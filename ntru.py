...
class Ntru:
    # all the parameter we need to use in NTRU algo
	N, p, q, d, f, g, h = None, None, None, None, None, None, None
	f_p, f_q, D = None, None, None
    # set the parameter into initialized
    ...
    # generating the public key through the f, g and d parameters
    # using ploy calculate
    ...
    # set public key
    # just using the public key generate before
    ...
    # decryption using the encrypted message and good base
